...
private:
    static void generatePawnsAll(Position const& position, Color color, bool only_attack, Moves &moves);
    ...
    static void generatePawnsEnPassant(Board const& board, Color color, uint8_t cell, Moves &moves);
    static void generateCastle(Board const& board, Color color, bool only_attack, Moves &moves);
